...
class condicoesIniciais:
    ...
    def gerar_posicoes (self, qntd:int, int_x:list, int_y:list, dist_min_x:float=10, dist_min_y:float=10):
        """
    ...
    def gerar_momentos (self, qntd:int, int_x:list, int_y:list, int_min_x:float=.1, int_min_y:float=.1):
        """
    ...
    def gerar_velocidades (self, qntd:int, int_x:list, int_y:list, int_min_x:float=.1, int_min_y:float=.1):
        """
